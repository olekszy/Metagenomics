...
do
#a=${z#trimmed/}
/home/fagi/miniconda3/libexec/kraken2 --threads 32 --db /home/fagi/minikraken2_v1_8GB  --fastq-input $a  --report reportskraken/report_$a --output outputs/output_$a.krona
