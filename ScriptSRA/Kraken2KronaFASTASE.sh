...
#rev=$(ls *.fas*| sed '2q;d')
#a=${z#trimmed/}
/home/fagi/miniconda3/libexec/kraken2 --threads 32 --db /home/fagi/minikraken2_v1_8GB --fastq-input $for --report reportskraken/report_$for --output outputs/output_$for.krona
